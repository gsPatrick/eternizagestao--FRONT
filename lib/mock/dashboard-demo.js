/* -------------------------------------------------------------------------
 * Mock do dashboard — dados falsos, ricos e bonitos, usados APENAS na vitrine
 * da landing (PanelShowcase). MESMO shape que getDashboard() retorna.
 * Nenhuma chamada de API é feita: é 100% estático/gerado no cliente.
 * ------------------------------------------------------------------------- */
