export const NAV_GROUPS = [
  ...
  },
  {
    label: "Gestão",
    items: [
      // "Documentos" saiu da sidebar (pedido do cliente): os documentos oficiais
      // são baixados/gerados no CONTEXTO — na sepultura (certidão de perpetuidade)
      // e no sepultado (autorização de sepultamento), sempre na hora. A página
      // /painel/documentos continua existindo por link direto, só não no menu.
