...
// body: { cemeteryId, contentBase64, fileName, mimeType } → { id, fileUrl }
export const uploadOrthophoto = (body) => api.post("/orthophotos", body);

// body: { corners:{tl,tr,br,bl}, opacity, active } — salva a posição/estado.
export const updateOrthophoto = (id, body) => api.patch(`/orthophotos/${id}`, body);
...
// contexto do mapa → { center:[lat,lng]|null, name, orthophoto }
