...
// Fallback HARDCODED para a API de produção (EasyPanel). Em dev, o .env.local
// aponta para http://localhost:3333/api/v1 e tem prioridade sobre este default.
const BASE_URL =
  process.env.NEXT_PUBLIC_API_URL ||
  "https://eternizagestao-eternizagestao--api.0yjn0n.easypanel.host/api/v1";
